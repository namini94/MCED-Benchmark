...
def plot_cancer_type_prediction_accuracy(class_names, top1_accuracies, top2_accuracies, 
    ...
    plt.title('Identification of cancer type by XGBOOST', 
...
def main():
    ...
    try:
        ...
        output_dir = 'cancer_xgboost_multi'
        os.makedirs(output_dir, exist_ok=True)
        ...
        model_file = os.path.join(output_dir, 'xgboost_cancer_type_model.pkl')
        ...
        print(f"Model, label encoder, and scaler saved to: {output_dir}")
        ...
        with open(os.path.join(output_dir, 'predict_cancer_type.py'), 'w') as f:
            ...
            f.write("with open('xgboost_cancer_type_model.pkl', 'rb') as f:\n")
            ...
            f.write("    --------\n")
            f.write("    tuple\n")
            f.write("        Tuple of (predicted_labels, probabilities)\n")
            f.write("    \"\"\"\n")
        ...
        print("\nMulticlass cancer type prediction pipeline completed successfully!")
